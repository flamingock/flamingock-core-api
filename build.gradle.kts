...
publishing {
    publications {
        create<MavenPublication>("maven") {
            ...
            artifactId = "flamingock-core-api"

            pom {
                name.set("flamingock-core-api")
                description.set("Public API annotations and interfaces for defining changes, stages, and templates")
                ...
                issueManagement {
                    system.set("GitHub")
                    url.set("https://github.com/flamingock/flamingock-java-core-api/issues")
                }
                ...
                scm {
                    connection.set("scm:git:git://github.com/flamingock/flamingock-java-core-api.git")
                    developerConnection.set("scm:git:ssh://github.com/flamingock/flamingock-java-core-api.git")
                    url.set("https://github.com/flamingock/flamingock-java-core-api")
                }
            }
        }
    }
